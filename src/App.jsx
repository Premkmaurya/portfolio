...
function App() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      // Animation 1: Initial page load reveal (runs first)
      ...
      // Wait for the timeline to complete, then activate ScrollTrigger
      // This ensures the reveal animation finishes before scroll animations start
      tl.add(() => {
        // Animation 2: Horizontal scroll (activates AFTER reveal completes)
